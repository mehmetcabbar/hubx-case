...
const Hero = () => {
    return (
        <div className="w-full h-[613px] grid lg:grid-cols-2 grid-cols-1 gap gap-10 px-6">
            <div className={"mx-auto content-end lg:order-1 order-2 overflow-y-auto scrollbar-hidden pt-32 lg:pt-0"}>
                {/* TODO: I will check mobile design problem */}
            ...
            <div className='flex justify-center align-middle items-center w-full lg:w-[556px] h-auto lg:order-2 order-1'>
                <div className='flex-none lg:text-right text-center'>
                    ...
                    <div className='mt-5 text-primary font-sf-pro-display font-normal text-sm lg:text-xl px-6 lg:px-0'>
                        Scan any document instantly with your mobile device <br /> by just a few steps. Save as PDF,JPG,ZIP,TXT and Word format.
                    </div>
                    <div className='mt-6'>
                        <MyButton />
                    </div>
